...
zip_iterable = zip(
    itertools.repeat(single_element),
    *zip(*itertools.product(double_element[1:], triple_element[1:])),
)
...
@pytest.mark.parametrize(
    "endpoint,group_by,report_filter",
    [
        pytest.param(
            AWS_COST_PATH,
            {"account": "*"},
            {"resolution": "daily", "time_scope_value": -10, "time_scope_units": "day"},
            id="cost-account-last10days",
        ),
        pytest.param(
            AWS_COST_PATH,
            {"account": "*"},
            {"resolution": "daily", "time_scope_value": -30, "time_scope_units": "day"},
            id="cost-account-last30days",
        ),
        pytest.param(
            AWS_COST_PATH,
            {"account": "*"},
            {"resolution": "daily", "time_scope_value": -90, "time_scope_units": "day"},
            id="cost-account-last90days",
        ),
        pytest.param(
            AWS_COST_PATH,
            {"account": "*"},
            {"resolution": "daily", "time_scope_value": -1, "time_scope_units": "month"},
            id="cost-account-last-month-daily",
        ),
        pytest.param(
            AWS_COST_PATH,
            {"account": "*"},
            {"resolution": "daily", "time_scope_value": -2, "time_scope_units": "month"},
            id="cost-account-two-months-ago-daily",
        ),
        pytest.param(
            AWS_COST_PATH,
            {"account": "*"},
            {"resolution": "monthly", "time_scope_value": -1, "time_scope_units": "month"},
            id="cost-account-last-month-monthly",
        ),
        pytest.param(
            AWS_COST_PATH,
            {"account": "*"},
            {"resolution": "monthly", "time_scope_value": -2, "time_scope_units": "month"},
            id="cost-account-two-months-ago-monthly",
        ),
        pytest.param(
            AWS_COST_PATH,
            {"service": "*"},
